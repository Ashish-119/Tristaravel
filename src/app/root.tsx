  ...
  return (
    <html lang="en">
      <head>
        ...
        <Meta />
        <Links />
        {/* Dev-only error overlay. The source lives at src/__create and is served
            by Vite during `dev`; in a production build that path 404s, so only
            inject it in development. */}
        {import.meta.env.DEV ? (
          <script type="module" src="/src/__create/dev-error-overlay.js"></script>
        ) : null}
        {/* Served from public/ so it resolves in both dev and the production build. */}
